...
app = Flask(__name__)
app.secret_key = os.environ.get("SECRET_KEY", "jyesta_secret_key_2025")
...
@app.route("/admin/prediction/delete/<int:pid>", methods=["POST"])
...
@app.route("/admin/contact/delete/<int:cid>", methods=["POST"])
...
@app.route("/admin/about/delete/<int:sid>", methods=["POST"])
